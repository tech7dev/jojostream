package com.tech7.jojostream.config;
...
public class Global {
    public static final String API_URL = "https://api.jojostream.com/api/";     //https://flix.virmana.com/api/    //https://api.jojostream.com/api/
